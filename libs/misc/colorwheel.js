...
(function (root, factory) {
  ...
  ColorWheel.prototype.delete = function (){
    this.dispatch.on('bindData.theme', null);
    this.dispatch.on('update.theme', null);
    this.container.select('.theme').selectAll('.theme__swatch').remove();
    this.container.select('.wheel').remove();
  };
